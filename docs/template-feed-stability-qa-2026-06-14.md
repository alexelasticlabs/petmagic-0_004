...
> Historical QA evidence log. This file preserves the June 2026 template-feed
> hardening notes and should not be used as the current release status. For the
> current production-readiness gate, use
> `docs/economy-release-gate-2026-07-03.md` and
> `docs/audit-notifications-tokens-purchases-economy-2026-07-03.md`.
