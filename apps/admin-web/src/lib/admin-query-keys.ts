...
export const adminQueryKeys = {
  ...
  economyLedger: (source: string, statusUserKey: string) => ["admin", "economy", "ledger", source, statusUserKey] as const,
  economyPurchases: (status: string) => ["admin", "economy", "purchases", status] as const,
  economySubscriptions: (status: string, provider: string) => ["admin", "economy", "subscriptions", status, provider] as const,
  ...
  supportInboxRoot,
  supportInbox: (status: string, assignment: string) => [...supportInboxRoot, status, assignment] as const,
