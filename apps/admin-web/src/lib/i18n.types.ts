...
export type Dictionary = {
  ...
  walletRecentActivityTitle: string;
  walletRecentActivityDescription: string;
  ...
  walletAdjustmentOpenAction: string;
  walletAdjustmentCloseAction: string;
  ...
  walletReasonRequiredHint: string;
  walletAmountInvalidHint: string;
  walletDebitBalanceHint: string;
  ...
  walletRefreshWarning: string;
  walletPendingRecoveryWarning: string;
  walletLedgerManualAdjustment: string;
  walletLedgerGenerationSpend: string;
  walletLedgerGenerationRefund: string;
  walletLedgerPurchase: string;
  walletLedgerPurchaseRefund: string;
  walletLedgerBonus: string;
  walletLedgerSubscription: string;
  walletLedgerPromo: string;
  walletLedgerReferral: string;
  walletLedgerWatermarkUnlock: string;
  walletLedgerOther: string;
  userNoAvatar: string;
  ...
  supportAttachmentRetryUnavailable: string;
  supportAttachmentTooLarge: string;
  supportAttachmentTypeInvalid: string;
  supportMessageTooLong: string;
  supportReplyTargetInvalid: string;
