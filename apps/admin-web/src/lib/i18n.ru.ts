...
export const ruDictionary: Dictionary = {
  ...
  editorReplaceFile: "Заменить файл",
  editorUploadOnSaveHint:
    "Файл загрузится автоматически при сохранении. Можно загрузить его отдельно сейчас.",
  editorBasicsHint: "Название, описание и условия использования, которые увидит пользователь.",
  editorMediaHint: "Превью показывает результат. Референс задаёт движения для генерации видео.",
  editorImageMediaHint: "Добавьте пример результата для карточки шаблона.",
  editorAiHint: "Выберите модель и опишите нужный результат. Prompt можно оставить пустым.",
  editorAdvancedSettings: "Дополнительные настройки",
  editorAdvancedHint: "Бейдж, тестовый доступ и использование результатов генерации.",
  editorNavigationLabel: "Разделы редактора",
  editorPreviewTitle: "Карточка в приложении",
  editorUnsaved: "Есть несохранённые изменения",
  editorSavedState: "Нет несохранённых изменений",
  editorDiscardConfirm: "Несохранённые изменения будут потеряны. Продолжить?",
  editorSavingProgress: "Сохраняем шаблон…",
  editorUploadingPreview: "Загружаем и обрабатываем превью…",
  editorUploadingReference: "Загружаем и проверяем референс…",
  editorCategoryLoadError: "Не удалось загрузить категории. Остальные поля доступны.",
  editorCategoryEmpty: "Нет доступных категорий. Создайте категорию в разделе «Категории».",
  editorQaPublishHint: "После сохранения шаблон будет доступен только для QA.",
  editorPreviewFormats: "JPG, PNG, WebP, GIF, MP4, MOV, WebM · до 25 МБ. Видео: 0,5–18 секунд.",
  editorReferenceFormats: "MP4 · до 100 МБ. Длительность проверяется на сервере.",
  editorSectionBasics: "Данные шаблона",
  editorSectionMedia: "Медиа",
  editorSectionAi: "Генерация",
  editorAllUsersAccess: "Все пользователи",
  editorUnknownModel: "Сохранённая модель недоступна. Выберите модель из списка.",
