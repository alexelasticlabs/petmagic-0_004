...
const templateAnalyticsCopy = {
  ru: {
    ...
    views: "Просмотры",
    viewsHint: "События просмотров из публичного API шаблонов.",
    ...
    generationConversionHint: "Доля успешных заданий среди запусков.",
    tokenSpend: "Потрачено PawSpark",
    tokenSpendHint: "Суммарная стоимость запусков в PawSpark.",
    complaints: "Жалобы",
    complaintsHint: "События жалоб из публичного API аналитики.",
    feedbackTitle: "Жалобы и фидбек",
    feedbackHint:
      "Последние обращения пользователей по шаблону: жалобы и фидбек с текстом и метаданными.",
    ...
    anonymousUser: "анон",
    feedbackSummaryTitle: "Сводка фидбека",
    feedbackSummaryNegativeWarning: "У шаблона высокий негативный фидбек.",
    feedbackSummaryDescription:
      "Сводка позитивных, нейтральных и негативных оценок по новому потоку фидбека.",
    ...
    snapshotHint:
      "Этот блок собирается из существующей модели административной статистики и служит опорной сводкой для панели выше.",
    trendTitle: "Динамика запусков",
    trendHint: "Группировка заданий генерации по дням создания шаблонных запусков.",
    trendEmpty: "Для этого шаблона ещё нет исторических точек тренда.",
    trendChartAriaLabel: "График динамики запусков шаблона",
    chartRuns: "Запуски",
    ...
    sourcesHint: "Реальная разбивка источников из событий просмотра шаблонов.",
    ...
    retentionHint: "Реальная операционная воронка по заданиям генерации.",
    ...
    geographyHint: "Реальная география из событий публичного трафика, если страна была записана.",
    devicesTitle: "Устройства",
    devicesHint: "Реальное распределение устройств из записанных событий аналитики.",
    recentRunsTitle: "Последние генерации",
    recentRunsHint: "Последние задания по этому шаблону с кратким операционным срезом.",
    recentRunsAllHint:
    ...
    failedRunsHint: "Все завершившиеся с ошибкой генерации по шаблону с кодом и текстом причины.",
    ...
    noOutput: "Нет",
    failureBreakdownTitle: "Разбивка ошибок",
    failureBreakdownHint: "Сводка по кодам ошибок из завершившихся с ошибкой заданий генерации.",
    failuresEmpty: "Пока нет зарегистрированных ошибок по этому шаблону.",
    lastFailure: "Последняя",
    unknownFailure: "Неизвестная ошибка",
    preprocessingModel: "Модель изображения",
    motionModel: "Модель движения",
    noData:
  ...
  en: {
    ...
    trendChartAriaLabel: "Template analytics trend chart",
    chartRuns: "Runs",
