                                    ...
                                    <tr key={config.configurationId}>
                                        ...
                                        <td>
                                            <input
                                                value={draft.region}
                                                onChange={(event) =>
                                                    updateProviderConfigDraft(setProviderConfigDrafts, config.configurationId, {
                                                        region: event.target.value.toUpperCase(),
                                                    })
                                                }
                                                className={styles.input}
                                        ...
                                        <td>
                                            <div className={styles.tableActions}>
                                                <Button onClick={() => onSaveProviderConfig(config.configurationId)} disabled={isSavingConfig}>
