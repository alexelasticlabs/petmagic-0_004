    ...
    return _RewardsGlassPanel(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final compact = constraints.maxWidth < 368;
          final badge = Stack(
          ...
          final actionButton = _GradientActionButton(
            label: isClaimingAd
                ? text.profileLoadingAction
                : text.walletWatchAdAction,
            icon: isClaimingAd ? Icons.hourglass_top_rounded : Icons.play_arrow,
            isLoading: isClaimingAd,
            onPressed: isLimitReached || isClaimingAd ? null : onClaimAd,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            text.walletAdRewardRemaining(remaining),
                            style: TextStyle(
                              color: colors.textSoft,
                              fontSize: 12,
