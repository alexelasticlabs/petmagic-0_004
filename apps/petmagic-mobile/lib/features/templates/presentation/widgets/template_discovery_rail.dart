...
class TemplateDiscoveryRail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final footerHeight = math.max(
      50,
      14 + textScaler.scale(11.5) * 1.25 + textScaler.scale(10) * 1.25,
    );
...
class _DiscoveryTemplateTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      container: true,
      button: true,
      label: '${template.title}, $mediaLabel, $accessLabel',
      onTap: onPressed,
      child: ExcludeSemantics(
        child: PetMagicInteractiveSurface(
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                        left: 7,
                        top: 7,
                        child: _MediaTypeBadge(isVideo: template.isVideo),
                      ),
              ...
              _TemplateAccessLine(template: template),
            ],
          ),
        ),
      ),
