  ...
  Future<List<PetPhoto>> fetchPetPhotos(
    ...
    return [
      PetPhoto(
        ...
        url: 'https://cdn.petgpt.app/pet-original.jpg',
        thumbnailUrl: 'https://cdn.petgpt.app/pet-thumb.jpg',
        fileName: 'pet.jpg',
  ...
  Future<List<PetProfile>> fetchPets({RequestCancellation? cancelToken}) async {
    return [
      PetProfile(
        ...
        type: 'dog',
        breed: 'Corgi',
        avatarUrl: 'https://cdn.petgpt.app/bella-avatar.jpg',
        photosCount: 1,
  ...
  Future<List<PetPhoto>> fetchPetPhotos(
    ...
    return [
      PetPhoto(
        ...
        url: 'https://cdn.petgpt.app/bella-original.jpg',
        thumbnailUrl: 'https://cdn.petgpt.app/bella-thumb.jpg',
        fileName: 'bella.jpg',
        contentType: 'image/jpeg',
        isFavorite: true,
        isAvatar: true,
    ...
    createdCreations
      ...
      ..add(
        generation.copyWith(
          ...
          outputUrl: 'https://cdn.petgpt.app/generated-bella.jpg',
          resultPreviewUrl: 'https://cdn.petgpt.app/generated-bella-thumb.jpg',
