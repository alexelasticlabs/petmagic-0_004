...
{
    /// <inheritdoc />
    public partial class AddEconomyPushOutbox : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "economy_push_outbox",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_economy_push_outbox", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_economy_push_outbox_DeduplicationKey",
                table: "economy_push_outbox",
                column: "DeduplicationKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_economy_push_outbox_Status_LockExpiresAtUtc",
                table: "economy_push_outbox",
                columns: new[] { "Status", "LockExpiresAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_economy_push_outbox_Status_NextAttemptAtUtc_CreatedAtUtc",
                table: "economy_push_outbox",
                columns: new[] { "Status", "NextAttemptAtUtc", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_economy_push_outbox_UserId",
                table: "economy_push_outbox",
                column: "UserId");
        }
