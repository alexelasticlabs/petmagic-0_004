    ...
    private static async Task SeedPaymentProviderConfigurationsAsync(EconomyDbContext dbContext, string defaultMode)
    {
        ...
        var configs = new[]
        {
            ...
            new PaymentProviderConfiguration
            {
                ...
                Mode = defaultMode,
                Notes = "Owner-approved Stripe alternative billing route for iOS in EU storefronts.",
                CreatedAtUtc = now,
                UpdatedAtUtc = now
            },
            new PaymentProviderConfiguration
            {
                ...
                WarningMessage = "Stripe payment opens in a secure payment form inside PetMagic. Provider terms and support may differ from App Store.",
                Mode = defaultMode,
                Notes = "Owner-approved Stripe alternative billing route for the iOS US storefront.",
                CreatedAtUtc = now,
                UpdatedAtUtc = now
            },
            new PaymentProviderConfiguration
