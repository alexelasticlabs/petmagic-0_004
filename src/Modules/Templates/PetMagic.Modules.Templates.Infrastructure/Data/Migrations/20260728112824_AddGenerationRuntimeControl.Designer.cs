...
namespace PetMagic.Modules.Templates.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260728112824_AddGenerationRuntimeControl")]
    partial class AddGenerationRuntimeControl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetMagic.Modules.Templates.Infrastructure.Entities.TemplateFalProviderHealthSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("templates_fal_provider_health", (string)null);
                });
            ...
            modelBuilder.Entity("PetMagic.Modules.Templates.Infrastructure.Entities.TemplateGenerationOperationalAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ResolvedAtUtc", "UpdatedAtUtc")
                        .HasDatabaseName("IX_tgoa_ResolvedAtUtc_UpdatedAtUtc");

                    b.ToTable("templates_generation_operational_alerts", (string)null);
                });

            modelBuilder.Entity("PetMagic.Modules.Templates.Infrastructure.Entities.TemplateGenerationOperationalAlertAcknowledgement", b =>
                {
                    ...
                    b.Property<DateTime>("AlertActivatedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("AcknowledgedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("AlertId", "AdminUserId");

                    b.HasIndex("AdminUserId", "AcknowledgedAtUtc")
                        .HasDatabaseName("IX_tgoaa_AdminUserId_AcknowledgedAtUtc");

                    b.ToTable("templates_generation_operational_alert_acknowledgements", (string)null);
                });

            modelBuilder.Entity("PetMagic.Modules.Templates.Infrastructure.Entities.TemplateGenerationRuntimeSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DrainOperationId")
                        .HasColumnType("uuid");

                    b.Property<decimal>("FalBalanceCriticalThresholdUsd")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<decimal>("FalBalanceLowThresholdUsd")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<int>("FalConfiguredConcurrency")
                        .HasColumnType("integer");

                    b.Property<int>("FalReservedConcurrency")
                        .HasColumnType("integer");

                    b.Property<int>("GlobalMaxConcurrent")
                        .HasColumnType("integer");

                    b.Property<int>("ImageMaxConcurrent")
                        .HasColumnType("integer");

                    b.Property<int>("ImageProtectedConcurrent")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("NewClaimsPaused")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("VideoBorrowMaxConcurrent")
                        .HasColumnType("integer");

                    b.Property<int>("VideoGuaranteedConcurrent")
                        .HasColumnType("integer");

                    b.Property<int>("VideoMaxConcurrent")
                        .HasColumnType("integer");

                    b.Property<int>("WorkerLoopsPerInstance")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("templates_generation_runtime_settings", (string)null);
                });
            ...
            modelBuilder.Entity("PetMagic.Modules.Templates.Infrastructure.Entities.TemplateRenderScaleOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<long?>("DrainRuntimeVersion")
                        .HasColumnType("bigint");

                    b.Property<DateTime?>("DrainStartedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int?>("InitialInstances")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("LoopsPerInstance")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("ScaleRequestedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int>("TargetInstances")
                        .HasColumnType("integer");

                    b.Property<DateTime>("UpdatedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("VerificationDeadlineAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("templates_render_scale_operations", (string)null);
                });
            ...
            modelBuilder.Entity("PetMagic.Modules.Templates.Infrastructure.Entities.TemplateRuntimeConfigFingerprint", b =>
                {
                    ...
                    b.Property<long>("AppliedSettingsVersion")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("ConfiguredLoops")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetMagic.Modules.Templates.Infrastructure.Entities.TemplateGenerationOperationalAlertAcknowledgement", b =>
                {
                    b.HasOne("PetMagic.Modules.Templates.Infrastructure.Entities.TemplateGenerationOperationalAlert", "Alert")
