...
public sealed class TemplatesDbContext(DbContextOptions<TemplatesDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<TemplateGenerationJob>(entity =>
        {
            ...
            entity.Property(x => x.GamificationLastErrorCode).HasMaxLength(128);
            entity.Property(x => x.GamificationShareLastErrorCode).HasMaxLength(128);
            ...
            entity.HasIndex(x => new { x.Status, x.GamificationNextAttemptAtUtc, x.CompletedAtUtc })
                .HasDatabaseName("IX_tgj_PendingGamification")
                .HasFilter("\"Status\" = 3 AND \"GamificationProcessedAtUtc\" IS NULL");
            entity.HasIndex(x => new { x.GamificationShareNextAttemptAtUtc, x.GamificationShareRequestedAtUtc })
