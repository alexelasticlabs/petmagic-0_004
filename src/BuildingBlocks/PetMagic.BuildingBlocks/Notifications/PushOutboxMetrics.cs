...
public static class PushOutboxMetrics
{
    ...
    public static void RecordRetry(string module) => Retries.Add(1, new KeyValuePair<string, object?>("module", module));

    public static void RecordDeadLetter(string module) => DeadLetters.Add(1, new KeyValuePair<string, object?>("module", module));

    public static void RecordSent(string module) => Sent.Add(1, new KeyValuePair<string, object?>("module", module));
