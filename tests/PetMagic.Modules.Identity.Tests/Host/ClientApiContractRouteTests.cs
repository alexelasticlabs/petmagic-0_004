...
public sealed class ClientApiContractRouteTests
{
    public static TheoryData<string, string, string> MobileClientRoutes => new()
    {
        ...
        { "GET", "/api/generation-results/{resultId:guid}/compatible-templates", "mobile compatible templates" },
        { "POST", "/api/generations/from-pet", "mobile generation from pet" },
        { "POST", "/api/generations/from-result", "mobile generation from result" },
        { "POST", "/api/generations/{generationId:guid}/generate-similar", "mobile similar generation" },
        { "GET", "/api/generations/{generationId:guid}", "mobile legacy generation detail" },
        { "POST", "/api/generations/{generationId:guid}/remove-watermark", "mobile legacy remove watermark" },
        { "GET", "/api/generations/{generationId:guid}/download", "mobile legacy generation download" },
        { "POST", "/api/generations/{generationId:guid}/share", "mobile legacy generation share" },
