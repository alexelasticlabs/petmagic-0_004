...
public sealed class ClientApiContractRouteTests
{
    public static TheoryData<string, string, string> MobileClientRoutes => new()
    {
        ...
        { "POST", "/api/auth/password-reset/request", "mobile password reset request" },
        { "POST", "/api/auth/password-reset/confirm", "mobile password reset" },
    ...
    public static TheoryData<string, string, string> AdminClientRoutes => new()
    {
        ...
        { "POST", "/api/admin/templates/generations/{generationId:guid}/cancel", "admin cancel generation" },
        { "POST", "/api/admin/templates/generations/{generationId:guid}/retry", "admin retry generation" },
        { "POST", "/api/admin/templates/generations/{generationId:guid}/retry-refund", "admin retry generation refund" },
